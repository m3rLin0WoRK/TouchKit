...
public class TKDragAndDropRecognizer : TKAbstractGestureRecognizer
{
	public event Action<TKDragAndDropRecognizer> gestureRecognizedEvent;
	public event Action<TKDragAndDropRecognizer> gestureCompleteEvent;
	...
	public TKDragAndDropRecognizer( float minPanDistanceCm = 0.5f )
	{
